...
<table style={{width:"100%"}} border="0px" solid="#ebebe0" frame="box" cellpadding="0" cellspacing="0" border-collapse="collapse">
<tr>
<td style={{borderRight:"1px"}} solid="#ebebe0">
...
<span className="fa fa-star checked" style={{color:"orange"}}></span>
  ...
  <span className="fa fa-star"></span>
<p>
<i className="fa fa-shopping-cart" style={{color:"orange"}}float="right" margin-right="9px"></i></p>
</td>
